...
const LOCAL_STICKY_PROJECTS: ProjectGridItem[] = [
  { _id: "local-s01", title: "Interactive concept", href: "/project-details", cursorText: "View Work", tags: ["UI/UX", "Development", "Brand"] },
  { _id: "local-s02", title: "Creative studio template", href: "/project-details", cursorText: "View Work", tags: ["Brand", "Marketing", "Website"] },
  { _id: "local-s03", title: "Creative studio template", href: "/project-details", cursorText: "View Work", tags: ["Brand", "Marketing", "Website"] },
  { _id: "local-s04", title: "Interactive concept", href: "/project-details", cursorText: "View Work", tags: ["UI/UX", "Development", "Brand"] },
];
...
export default function ProjectsGridStickyShowcase({ projects }: Props) {
  const p = (projects && projects.length > 0 ? projects : LOCAL_STICKY_PROJECTS);
  return (
    <CommonLoadAnimation>
      <>
                        ...
                        <div className="mxd-project-item__caption">
                          <div className="mxd-project-item__name">
                            <Link
                              ...
                              href={p[0]?.href ?? "/project-details"}
                            >
                              {p[0]?.title ?? "Interactive concept"}
                            </Link>
                          </div>
                          <div className="mxd-project-item__tags">
                            {(p[0]?.tags ?? ["UI/UX", "Development", "Brand"]).map((tag) => (
                        ...
                        <div className="mxd-project-item__caption">
                          <div className="mxd-project-item__name">
                            <Link
                              ...
                              href={p[1]?.href ?? "/project-details"}
                            >
                              {p[1]?.title ?? "Creative studio template"}
                            </Link>
                          </div>
                          <div className="mxd-project-item__tags">
                            {(p[1]?.tags ?? ["Brand", "Marketing", "Website"]).map((tag) => (
                              <TextScramble key={tag} className="tag tag-s tag-medium mxd-scramble">
                                {tag}
                              </TextScramble>
                            ))}
                    ...
                    <div className="row g-0 mxd-projects-grid__gallery">
                      ...
                      >
                        ...
                        <div className="mxd-project-item__caption">
                          ...
                          <div className="mxd-project-item__tags">
                            {(p[3]?.tags ?? ["UI/UX", "Development", "Brand"]).map((tag) => (
                              <TextScramble key={tag} className="tag tag-s tag-medium mxd-scramble">
                                {tag}
                              </TextScramble>
                            ))}
